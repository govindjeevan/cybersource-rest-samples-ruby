...
# * This is a sample code to call AuthenticationWithNoRedirect

public
class AuthenticationWithNoRedirect
  def main
    config = MerchantConfiguration.new.merchantConfigProp()
    api_client = CyberSource::ApiClient.new
    api_instance = CyberSource::PayerAuthenticationApi.new(api_client, config)

    # Calling AuthenticationWithNoRedirect Sample code
  ...
  if __FILE__ == $0
    AuthenticationWithNoRedirect.new.main
  end
end
